            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center"><h5 class="m-0 p-0">Most Recenly Detected</h5> <a href="active.php" class="btn btn-success btn">See All</a></div>
